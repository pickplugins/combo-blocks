  ...
  return (
    <div className="">
      ...
      <div className='flex justify-between items-center'>
        <div className="cursor-pointer bg-indigo-300 hover:bg-indigo-500 text-white px-3 py-1 my-3" onClick={ev => {
      ...
      <ToggleControl
        ...
        onChange={(arg) => {
          ...
          if (isMultiple) {
            if (isImportant) {
              props.onChange(valArgs.join(', ').replace('!important', ''), 'maskSize');
