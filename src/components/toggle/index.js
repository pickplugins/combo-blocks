...
function Html(props) {
  ...
  return (
		<div className={`${props.className} pg-setting-input-text`}>
			<div
				className={`${isOpen? "bg-indigo-400" : "bg-indigo-200"}	hover:bg-indigo-400 border-0	border-b border-solid border-indigo-300 px-2 py-2 items-center cursor-pointer flex justify-between `}
				onClick={(ev) => {
