...
import PGFormFieldCalculations from "../../components/form-field-calculations";
...
registerBlockType(metadata, {
	...
	transforms: {
		from: [
			{
				type: "block",
				blocks: ["combo-blocks/form-field-textarea"],
				transform: (attributes) => {
					return createBlock("combo-blocks/form-field-input", attributes);
				},
			},
		],
		to: [
			{
				...
				blocks: ["combo-blocks/form-field-textarea"],
				transform: (attributes) => {
					return createBlock("combo-blocks/form-field-textarea", attributes);
				},
			},
		],
	},
	edit: function (props) {
		...
		var formId = context["combo-blocks/formId"];
			...
			<>
							...
							<PGtoggle
								...
								<PGtabs
									...
									<PGtab name="options">
										<PanelRow>
											...
											<SelectControl
												...
												options={[
													...
													{ label: __("Text", "combo-blocks"), value: "text" },
										...
										<ToggleControl
											className="my-3"
											label={__("Include With Email Body?", "combo-blocks")}
											help={
												input.options.includeMailBody
											...
											<>
												<PanelRow>
													...
													<SelectControl
														...
														options={[
															{
																label: __("Choose Pattern", "combo-blocks"),
																value: "",
															},
													...
													<>
														<PanelRow className="mb-4">
															<label
																for=""
																className="font-medium text-slate-900 ">
																{__("Custom Pattern", "combo-blocks")}
															</label>
															<InputControl
																className="mr-2"
				...
				<div {...blockProps}>
					...
					<div className="label-wrap">
						{icon.options.position == "beforeLabelText" && (
							<span
								className={icon.options.class}
								dangerouslySetInnerHTML={{ __html: iconHtml }}
							/>
						...
						{icon.options.position == "afterLabelText" && (
							<span
								className={icon.options.class}
								dangerouslySetInnerHTML={{ __html: iconHtml }}
							/>
