...
import PGChartOptions from "../../components/chart-options";
...
registerBlockType(metadata, {
	...
	edit: function (props) {
		...
		var legendProps = {
			display: { label: "Display", id: "display", value: true },
			position: { label: "Position", id: "position", value: "top" },
			align: { label: "Align", id: "align", value: "center" },
			maxHeight: { label: "Max Height", id: "maxHeight", value: null },
			maxWidth: { label: "Max Width", id: "maxWidth", value: null },
			fullSize: { label: "Full Size", id: "fullSize", value: true },
			reverse: { label: "Reverse", id: "reverse", value: false },
			rtl: { label: "RTL", id: "rtl", value: false },
			textDirection: {
		...
		var titleProps = {
			display: { label: "Display", id: "display", value: false },
			position: { label: "Position", id: "position", value: "top" },
			align: { label: "Align", id: "align", value: "center" },
			text: { label: "Text", id: "text", value: "" },
			padding: { label: "Padding", id: "padding", value: 10 },
			color: { label: "Color", id: "color", value: "#666" },
			font: {
				label: "Font",
				id: "font",
				value: {
		...
		var tooltipProps = {
			enabled: { label: "Enabled", id: "enabled", value: true },
			intersect: { label: "Intersect", id: "intersect", value: true },
			position: { label: "Position", id: "position", value: "average" },
			backgroundColor: {
				label: "Background Color",
				id: "backgroundColor",
				value: "rgba(0, 0, 0, 0.8)",
			},
			titleColor: { label: "Title Color", id: "titleColor", value: "#fff" },
			titleFont: {
				label: "Title Font",
				id: "titleFont",
				value: {
			...
			titleAlign: { label: "Title Align", id: "titleAlign", value: "left" },
			titleSpacing: { label: "Title Spacing", id: "titleSpacing", value: 2 },
			titleMarginBottom: {
				label: "Title Margin Bottom",
				id: "titleMarginBottom",
				value: 6,
			},
			bodyColor: { label: "Body Color", id: "bodyColor", value: "#fff" },
			bodyFont: {
				label: "Body Font",
				id: "bodyFont",
				value: {
			...
			bodyAlign: { label: "Body Align", id: "bodyAlign", value: "left" },
			bodySpacing: { label: "Body Spacing", id: "bodySpacing", value: 2 },
			footerColor: { label: "Footer Color", id: "footerColor", value: "#fff" },
			footerFont: {
				label: "Footer Font",
				id: "footerFont",
				value: {
			...
			footerAlign: { label: "Footer Align", id: "footerAlign", value: "left" },
			footerSpacing: { label: "Footer Spacing", id: "footerSpacing", value: 2 },
			footerMarginTop: {
				label: "Footer Margin Top",
				id: "footerMarginTop",
				value: 6,
			},
			padding: { label: "Padding", id: "padding", value: 6 },
			caretPadding: { label: "Caret Padding", id: "caretPadding", value: 2 },
			caretSize: { label: "Caret Size", id: "caretSize", value: 5 },
			cornerRadius: { label: "Corner Radius", id: "cornerRadius", value: 6 },
			multiKeyBackground: {
			...
			boxPadding: { label: "Box Padding", id: "boxPadding", value: 0 },
			usePointStyle: {
			...
			borderWidth: { label: "Border Width", id: "borderWidth", value: 0 },
			rtl: { label: "RTL", id: "rtl", value: false },
			textDirection: {
				label: "Text Direction",
				id: "textDirection",
			...
			xAlign: { label: "X Align", id: "xAlign", value: undefined },
			yAlign: { label: "Y Align", id: "yAlign", value: undefined },
		};
		var layoutProps = {
			padding: {
				label: "Padding",
			...
			autoPadding: { label: "Auto Padding", id: "autoPadding", value: true },
		};
		var animationProps = {
			animation: {
				label: "Animation",
				...
				value: {
					...
					easing: { label: "Easing", id: "easing", value: "easeOutQuart" },
					delay: { label: "Delay", id: "delay", value: 0 },
					...
					show: {
						...
						value: {
							animations: {
								...
								visible: { type: "boolean", from: false },
							},
						},
					},
					hide: {
					...
					<div className="pg-setting-input-text">
						...
						<PGtoggle
							...
							<PGChartOptions
								...
								objFor="legend"
								onChange={(prams) => {
									setAttributes({ legend: prams });
								}}
							/>
						</PGtoggle>
						<PGtoggle
							className="font-medium text-slate-900 "
							title={__("Title", "combo-blocks")}
							initialOpen={false}>
							<PGChartOptions
								obj={title}
								props={titleProps}
								objFor="title"
								onChange={(prams) => {
									setAttributes({ title: prams });
								}}
							/>
						</PGtoggle>
						<PGtoggle
							className="font-medium text-slate-900 "
							title={__("Subtitle", "combo-blocks")}
							initialOpen={false}>
							<PGChartOptions
								obj={subtitle}
								props={subtitleProps}
						...
						<PGtoggle
							...
							<PGChartOptions
								...
								objFor="layout"
								onChange={(prams) => {
									setAttributes({ layout: prams });
								}}
							/>
						</PGtoggle>
						<PGtoggle
							className="font-medium text-slate-900 "
							title={__("Animation", "combo-blocks")}
							initialOpen={false}>
							<PGChartOptions
								obj={animation}
