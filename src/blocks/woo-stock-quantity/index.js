	...
	edit: function (props) {
		...
		function onRemoveStyleStokQuantity(sudoScource, key) {
			...
			var objectX = isEmpty
				? myStore.deletePropertyDeep(object, [sudoScource, key])
				: object;
			setAttributes({ stockQuantity: objectX });
			var elementSelector = myStore.getElementSelector(
				sudoScource,
				stockQuantitySelector
			);
		...
		var stockQuantitySelector = blockClass + " .stockQuantity";
			...
			<>
				<InspectorControls>
					<div className="pg-setting-input-text">
						...
						<PGtoggle
							className="font-medium text-slate-900 "
							title={__("Stock Quantity", "combo-blocks")}
							initialOpen={false}>
							<PGtabs
								activeTab="options"
								orientation="horizontal"
									...
									<PanelRow>
										...
										<SelectControl
											...
											options={[
												...
												{
													label: __("Before Quantity", "combo-blocks"),
													value: "beforeQuantity",
												},
												{
													label: __("After Quantity", "combo-blocks"),
													value: "afterQuantity",
												},
												{
								...
								<div className="border border-solid border-gray-300 w-[95%] rounded-md p-5">
									<div className="flex justify-between mb-5">
										...
										<div
											...
											onClick={(ev) => {
												var content =
													'<!-- wp:combo-blocks/woo-stock-quantity {"wrapper":{"options":{"tag":"div","class":"pg-woo-stockQuantity"},"styles":{"color":[],"backgroundColor":[],"padding":[],"margin":[],"display":{"Desktop":"flex"},"borderRadius":[],"border":[],"boxShadow":[]}},"stockQuantity":{"options":{"tag":"div","text":"12","linkTo":"","linkToUrl":"","linkToMetaKey":"","linkTarget":"_blank","linkAttr":[],"customUrl":"","class":""},"styles":{"display":{"Desktop":"inline-block"},"width":[],"color":{"Desktop":"#6db55c"},"backgroundColor":[],"padding":{"Desktop":"5px 20px 5px 25px"},"margin":[],"fontSize":{"Desktop":"18px"},"lineHeight":[],"letterSpacing":[],"fontWeight":{"Desktop":"600"},"textDecoration":[],"textTransform":[],"borderRadius":{"Desktop":"32px 0px 0px 32px"},"border":{"Desktop":"1px solid #6db55c"},"borderRight":{"Desktop":"0px solid #000000"}}},"icon":{"options":{"library":"bootstrap","srcType":"class","iconSrc":"bi-check2","position":"","class":"stockQuantity-icon"},"styles":{"color":{"Desktop":"#89a56b"},"backgroundColor":[],"padding":[],"margin":[],"display":[],"fontSize":{"Desktop":"22px"},"lineHeight":[],"fontWeight":{"Desktop":"500"},"textDecoration":[]}},"prefix":{"styles":{"color":{"Desktop":""},"backgroundColor":{"Desktop":""}},"options":{"text":"","class":"prefix"}},"postfix":{"styles":{"color":{"Desktop":"#6db55c"},"backgroundColor":[],"fontSize":{"Desktop":"18px"},"fontWeight":{"Desktop":"600"},"margin":[],"border":{"Desktop":"1px solid #6db55c"},"display":{"Desktop":"inline-block"},"padding":{"Desktop":"5px 20px 5px 20px"},"borderRadius":{"Desktop":"0px 32px 32px 0px"}},"options":{"text":"IN STOCK","class":"postfix"}},"blockId":"pg55d329346f3e","blockCssY":{"items":{".pg55d329346f3e":{"display":{"Desktop":"flex"}},".pg55d329346f3e .stockQuantity-text":{"display":{"Desktop":"inline-block"},"color":{"Desktop":"#6db55c"},"padding":{"Desktop":"5px 20px 5px 25px"},"font-size":{"Desktop":"18px"},"font-weight":{"Desktop":"600"},"border-radius":{"Desktop":"32px 0px 0px 32px"},"border":{"Desktop":"1px solid #6db55c"},"border-right":{"Desktop":"0px solid #000000"}},".pg55d329346f3e .stockQuantity-icon":{"color":{"Desktop":"#89a56b"},"font-size":{"Desktop":"22px"},"font-weight":{"Desktop":"500"}},".pg55d329346f3e .postfix":{"color":{"Desktop":"#6db55c"},"font-size":{"Desktop":"18px"},"font-weight":{"Desktop":"600"},"border":{"Desktop":"1px solid #6db55c"},"display":{"Desktop":"inline-block"},"padding":{"Desktop":"5px 20px 5px 20px"},"border-radius":{"Desktop":"0px 32px 32px 0px"}}}}} /-->';
												wp.data
													.dispatch("core/block-editor")
													.replaceBlock(clientId, wp.blocks.parse(content));
											}}>
								...
								<>
									{wrapper.options.tag && (
										<CustomTag {...blockProps}>
											...
											{stockQuantity.options.linkTo.length == 0 && (
												<CustomTagPostTitle className="stockQuantity">
													{icon.options.position == "beforeQuantity" && (
														<span
															className={icon.options.class}
															dangerouslySetInnerHTML={{ __html: iconHtml }}
