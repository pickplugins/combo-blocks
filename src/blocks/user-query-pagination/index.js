...
registerBlockType(metadata, {
	...
	transforms: {
		from: [
			{
				type: "block",
				blocks: ["combo-blocks/post-query-pagination"],
				transform: (attributes) => {
					var atts = attributes;
					atts.pagination.options.class = "pagination pg-user-query-pagination";
					return createBlock("combo-blocks/user-query-pagination", atts);
				},
			},
		],
		to: [
			{
				...
				transform: (attributes) => {
					var atts = attributes;
					atts.pagination.options.class = "pagination pg-post-query-pagination";
					return createBlock("combo-blocks/post-query-pagination", atts);
				},
			},
		],
	},
	edit: function (props) {
		...
		useEffect(() => {
			if (parentAttributes[0] != undefined) {
				if (parentAttributes[0].name === "combo-blocks/post-grid") {
					...
					parentAttributes[0].name === "combo-blocks/filterable-grid"
				) {
