...
registerBlockType(metadata, {
	...
	edit: function (props) {
		...
		const [postCategoriesX, setPostCategoriesX] = liveMode
			...
			: useState([]);
		// // marking pro
		var postCategoriesIconPositionBasic = {
		...
		let iconPositionArgs = applyFilters(
			"comboBlocksPostCategoriesIconPosition",
			postCategoriesIconPositionBasic
		);
		var postCategoriesLinkToBasic = {
		...
		let linkToArgs = applyFilters(
			"comboBlocksPostCategoriesLinkTo",
			postCategoriesLinkToBasic
		);
