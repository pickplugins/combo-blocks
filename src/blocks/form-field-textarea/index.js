...
registerBlockType(metadata, {
	...
	edit: function (props) {
		...
		var inputSelector = blockClass + " textarea";
			...
			<>
				<InspectorControls>
					<div className="pg-setting-input-text" initialOpen={false}>
						...
						<PGtoggle
							className="font-medium text-slate-900 "
							title={__("Textarea", "combo-blocks")}
							initialOpen={false}>
							<PGtoggle
								className="font-medium text-slate-900 "
								title={__("Textarea Wrap", "combo-blocks")}
								initialOpen={false}>
								<PGtabs
									activeTab="options"
									orientation="horizontal"
				...
				<div {...blockProps}>
					...
					<div className="label-wrap">
						...
						{label.options.enable && (
							<label htmlFor="" className="font-medium text-slate-900 label">
								{label.options.text}
							</label>
						)}
