...
registerBlockType(metadata, {
	...
	edit: function (props) {
		...
		var itemSelector = blockClass + " .pg-team-showcase-item ";
		...
		useEffect(() => {
			...
			nthItemStyle.map((x, i) => {
				var selector = `${blockClass} .pg-team-showcase-item:nth-child(${i + 1
					})`;
		...
		const ALLOWED_BLOCKS = ["combo-blocks/team-members"];
		const MY_TEMPLATE = [
	...
	save: function (props) {
		...
		const blockProps = useBlockProps.save({
			className: ` ${blockId}  pg-team-showcase-item `,
		});
