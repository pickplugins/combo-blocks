...
registerBlockType(metadata, {
	...
	edit: function (props) {
		...
		var providersList = {
			instagram: { label: __("Instagram", "combo-blocks"), value: "instagram" },
			youtube: { label: __("youtube", "combo-blocks"), value: "youtube" },
			tiktok: { label: __("tiktok", "combo-blocks"), value: "tiktok" },
			github: { label: __("github", "combo-blocks"), value: "github" },
			figma: { label: __("figma", "combo-blocks"), value: "figma" },
		};
		var providerPrams = {
			youtube: { type: "", start: "", controls: 0, nocookie: 0 },
			tiktok: { type: "", start: "", controls: 0, nocookie: 0 },
		};
							...
							<div className="bg-slate-300 p-10 ">
								<div className="w-[400px] mx-auto my-0">
									<label
										...
										{__("Source Url", "combo-blocks")}
									</label>
									<InputControl
										placeholder="Enter the Url"
										value={iframe.options.src}
										onChange={(newVal) => {
											var options = { ...iframe.options, src: newVal };
											setAttributes({
												iframe: { ...iframe, options: options },
											});
										}}
									/>
								</div>
					...
					{iframe.options.src.length != 0 && (
						<CustomTagWrapper {...blockProps}>
							<iframe
								width="560"
								height="315"
								src={`https://www.youtube.com/embed/${iframe.options.src}`}
								title={iframe.options.title}
								frameborder="0"
