...
if (!defined('ABSPATH'))
  exit();
class ComboBlocksContentSliderItem
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/content-slider-item/block.json',
      array(
...
$ComboBlocksContentSliderItem = new ComboBlocksContentSliderItem();
