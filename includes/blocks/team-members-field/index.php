...
if (!defined('ABSPATH'))
  exit();
class ComboBlocksTeamMembersField
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/team-members-field/block.json',
      array(
...
$ComboBlocksTeamMembersField = new ComboBlocksTeamMembersField();
