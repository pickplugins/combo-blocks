...
if (!defined('ABSPATH'))
  exit();
class ComboBlocksImageAccordion
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/image-accordion/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    <?php
      ...
      <<?php echo combo_blocks_tag_escape($wrapperTag); ?> id="<?php echo esc_attr($wrapperID); ?>"
        class="<?php echo esc_attr($wrapperClass); ?> <?php echo esc_attr($blockId); ?> <?php echo esc_attr($blockAlign); ?>">
...
$ComboBlocksImageAccordion = new ComboBlocksImageAccordion();
