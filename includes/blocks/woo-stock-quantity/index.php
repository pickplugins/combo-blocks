...
if (!defined('ABSPATH'))
    exit();
class ComboBlocksWooStockQuantity
{
    ...
    {
        register_block_type(
            combo_blocks_dir . 'build/blocks/woo-stock-quantity/block.json',
            array(
...
?>
            <<?php echo combo_blocks_tag_escape($wrapperTag); ?> class="
                ...
                ?>
                    <<?php echo combo_blocks_tag_escape($skuTag); ?> class='stockQuantity' <?php //echo ($linkAttrStrsku); 
                        ...
                        <?php if ($iconPosition == 'afterQuantity') : ?>
                            <?php echo wp_kses_post($fontIconHtml); ?>
                        <?php endif; ?>
                    </<?php echo combo_blocks_tag_escape($skuTag); ?>>
                <?php else :
                    /* TO code reviewers, $linkAttrStr escaped correctly before, No need here.*/
                ?>
                    <<?php echo combo_blocks_tag_escape($skuTag); ?> class='stockQuantity' <?php //echo ($linkAttrStrsku); 
        ...
        ?>
            ...
            <?php else : ?>
                <?php if ($iconPosition == 'beforeQuantity') : ?>
                    <?php echo wp_kses_post($fontIconHtml); ?>
                <?php endif; ?>
                <<?php echo combo_blocks_tag_escape($skuTag); ?> class='stockQuantity'>
                    <?php echo wp_kses_post($productStockQuantity); ?>
                </<?php echo combo_blocks_tag_escape($skuTag); ?>>
                <?php if ($iconPosition == 'afterQuantity') : ?>
                    <?php echo wp_kses_post($fontIconHtml); ?>
...
$ComboBlocksWooStockQuantity = new ComboBlocksWooStockQuantity();
