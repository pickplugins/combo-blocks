...
class ComboBlocksArchiveTitle
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/archive-title/block.json',
      array(
...
?>
      <<?php echo combo_blocks_tag_escape($wrapperTag); ?> class="
        ...
        <?php else : ?>
          <<?php echo combo_blocks_tag_escape($archiveTitleTag); ?> class='archiveTitle' <?php //echo ($linkAttrStrarchiveTitle); 
                                                                                          ?>>
            <?php if ($iconPosition == 'beforeArchiveTitle') : ?>
              <?php echo wp_kses_post($fontIconHtml); ?>
            <?php endif; ?>
    ...
    ?>
      <?php if (!empty($archiveTitleLinkTo)) : ?>
        <a class='<?php echo esc_attr($blockId); ?> archiveTitle' <?php //echo ($linkAttrStrarchiveTitle); 
          ...
          <?php endif; ?>
          <?php if ($postfixText) : ?>
            <<?php echo combo_blocks_tag_escape($archiveTitleTag); ?> class="<?php echo esc_attr($postfixClass); ?>">
              <?php echo esc_attr($postfixText); ?>
            </<?php echo combo_blocks_tag_escape($archiveTitleTag); ?>>
          <?php endif; ?>
          <?php if ($iconPosition == 'afterPostfix') : ?>
      ...
      <?php else : ?>
        <<?php echo combo_blocks_tag_escape($archiveTitleTag); ?> class='<?php echo esc_attr($blockId); ?> archiveTitle'>
          <?php if ($iconPosition == 'beforePrefix') : ?>
            <?php echo wp_kses_post($fontIconHtml); ?>
          <?php endif; ?>
          <?php if ($prefixText) : ?>
...
$ComboBlocksArchiveTitle = new ComboBlocksArchiveTitle();
