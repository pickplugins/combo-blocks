...
if (!defined('ABSPATH'))
	exit();
class ComboBlocksTestimonialShowcase
{
	...
	{
		register_block_type(
			combo_blocks_dir . 'build/blocks/testimonial-showcase/block.json',
			array(
...
$ComboBlocksTestimonialShowcase = new ComboBlocksTestimonialShowcase();
