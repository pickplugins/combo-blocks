...
class ComboBlocksTableCell
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/table-td/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    ob_start();
?>
    <<?php echo combo_blocks_tag_escape($wrapperTag); ?> id="<?php echo esc_attr($wrapperID); ?>" class="<?php echo esc_attr($wrapperClass); ?> <?php echo esc_attr($blockId); ?> <?php echo esc_attr($blockAlign); ?>" <?php //echo $linkAttrStr;
                                                                                                                                                                                                                        ?>>
...
$ComboBlocksTableCell = new ComboBlocksTableCell();
