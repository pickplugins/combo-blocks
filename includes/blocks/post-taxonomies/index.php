...
if (!defined('ABSPATH'))
  exit();
class ComboBlocksPostTaxonomies
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/post-taxonomies/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    $frontTexttext = isset($frontTextOptions['text']) ? $frontTextOptions['text'] : __('Categories:', 'combo-blocks');
...
$ComboBlocksPostTaxonomies = new ComboBlocksPostTaxonomies();
