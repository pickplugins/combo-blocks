...
if (!defined('ABSPATH'))
    exit();
class ComboBlocksImageGalleryItem
{
    ...
    {
        register_block_type(
            combo_blocks_dir . 'build/blocks/image-gallery-item/block.json',
            array(
    ...
    function theHTML($attributes, $content, $block)
    {
        ...
        $galleryId = isset($block->context['combo-blocks/galleryId']) ? $block->context['combo-blocks/galleryId'] : '';
...
$ComboBlocksImageGalleryItem = new ComboBlocksImageGalleryItem();
