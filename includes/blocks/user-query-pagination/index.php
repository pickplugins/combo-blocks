...
if (!defined('ABSPATH'))
  exit();
class ComboBlocksUserQueryPagination
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/user-query-pagination/block.json',
      array(
  ...
  {
    if (has_block('combo-blocks/user-query-pagination')) {
    ...
    $comboBlocksScriptData[$postGridId]['pagination']['type'] = $paginationType;
    $comboBlocksScriptData[$postGridId]['pagination']['prevText'] = $prevText;
    $comboBlocksScriptData[$postGridId]['pagination']['nextText'] = $nextText;
    $comboBlocksScriptData[$postGridId]['pagination']['maxPageNum'] = $maxPageNum;
    $comboBlocksScriptData[$postGridId]['pagination']['noMorePosts'] = $noMorePosts;
    $comboBlocksScriptData[$postGridId]['pagination']['loadMoreText'] = $loadMoreText;
    $comboBlocksScriptData[$postGridId]['pagination']['loadingText'] = $loadingText;
    $comboBlocksScriptData[$postGridId]['pagination']['page'] = $paged;
    $comboBlocksScriptData[$postGridId]['pagination']['loadingIcon'] = '<i class="loademore-icon ' . $loadingIconSrc . '"></i>';
    $blockArgs = [
      'blockId' => $postGridId,
      'pagination' => [
        'type' => $paginationType,
...
?>
    <?php if ($paginationType == 'normal') : ?>
      <div id="pagination-<?php echo esc_attr($blockId); ?>" class="pagination <?php echo esc_attr($blockId); ?> ComboBlocksPostGrid-pagination <?php echo esc_attr($paginationType); ?>" data-blockargs="<?php echo esc_attr(json_encode($blockArgs)); ?>">
        <?php
    ...
    <?php if ($paginationType == 'filterable') : ?>
      <div id="pagination-<?php echo esc_attr($blockId); ?>" class="<?php echo esc_attr($blockId); ?>  pagination ComboBlocksPostGrid-pagination <?php echo esc_attr($paginationType); ?> pager-list mixitup-page-list pager-list-<?php echo esc_attr($postGridId); ?>" data-blockargs="<?php echo esc_attr(json_encode($blockArgs)); ?>">
      </div>
    <?php endif; ?>
...
$ComboBlocksUserQueryPagination = new ComboBlocksUserQueryPagination();
