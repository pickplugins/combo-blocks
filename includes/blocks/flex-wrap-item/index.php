...
class ComboBlocksFlexWrapItem
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/flex-wrap-item/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    <?php
      ...
      <<?php echo combo_blocks_tag_escape($wrapperTag); ?> id="
...
$ComboBlocksFlexWrapItem = new ComboBlocksFlexWrapItem();
