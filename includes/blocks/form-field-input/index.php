...
if (!defined('ABSPATH'))
  exit();
class ComboBlocksFormFieldInput
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/form-field-input/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    $formId = isset($block->context['combo-blocks/formId']) ? $block->context['combo-blocks/formId'] : '';
    ...
    if ($inputObjMap == 'userMeta') {
      $comboBlocksVars[$formId]['allowed_user_meta'][] = $inputNameOriginal;
    }
...
$ComboBlocksFormFieldInput = new ComboBlocksFormFieldInput();
