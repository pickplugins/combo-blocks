...
if (!defined('ABSPATH'))
  exit();
class ComboBlocksFormFieldFileMulti
{
  ...
  {
    register_block_type(
      combo_blocks_dir . 'build/blocks/form-field-file-multi/block.json',
      array(
...
$ComboBlocksFormFieldFileMulti = new ComboBlocksFormFieldFileMulti();
