...
we PickPlugins own the domain https://comboblocks.com and used for template libraries server, we do not collect any sensitive data.
https://comboblocks.com/terms-conditions/
...
1. Download the plugin and unzip it, make sure its under the folder name "combo-blocks"
...
https://comboblocks.com/privacy-policy/
